...
*Additional missing countries: Austria Ireland Switzerland
...
**data arrangement for synth

*reset id number and panel setting for the main synth
drop if idn == 10 | idn == 11 |  idn == 20 // excluding Luxembourg 10, Netherland 11,  Germany 20
drop if idn == 2 | idn == 6 | idn == 8 /* | idn == 12*/ | idn == 17 // Austria 2 /*Finland 6(missing in 1980s)  Ireland 8 /*Newzeland 12 start from 1986*/ Switzerland 17
drop if idn == 1 | idn == 3 |idn == 9 | idn == 14 | idn == 16 // Austalia 1 Belgium 3 Italy 9 Portugal 14 Sweden 16 <= Countries that pre-2000 LTC expenditures are zero or fluctuateed
...
global treated "9" // Japan
global counit "1(1)8"

*define treated id number and related numbers for LOO placebo
global treated_id "9"
global treated_id_minus1 "8"
global treated_id_minus2 "7"
global treated_id_minus3 "6"
