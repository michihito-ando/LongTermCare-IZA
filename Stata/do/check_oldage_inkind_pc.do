...
///////////////////////////////////////////////////////
* add new data 190701 of inkind benefits per elderly
merge 1:1 id_n year using "raw/old_benefits_in_kind_per_old" // 190701
drop _merge
drop if id == ""
rename p_bene_inkind_old_per_old oldage_inkind_pc2
///////////////////////////////////////////////////////
...
*gen oldage_inkind per capita 2019.6.30
gen oldage_inkind_pc = oldage_inkind * rgdpe /  elderly_persons
...
*den demeaned variables for suiside rates : some suiside rates in Japan are the highest in OECD and cannot be directly used.
...
keep Country year id idn  oldage_inkind_pc oldage_inkind_pc2 oldage_inkind gdp_pc_ppp gdp_pc_curUS rgdpe
order Country year id idn rgdpe gdp_pc_curUS gdp_pc_ppp oldage_inkind oldage_inkind_pc  oldage_inkind_pc2
save "temp/check_oldage_inkind_pc.dta", replace
