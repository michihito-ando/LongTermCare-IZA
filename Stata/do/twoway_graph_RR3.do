...
***Import data
import excel using "post_synth/twoway/post_synth_RR3_$outcome.xlsx", firstrow  clear
...
graph save Graph "graph/twoway/gph/synth_RR3_$outcome",replace
graph export  "graph/twoway/pdf/synth_RR3_$outcome.pdf",replace
