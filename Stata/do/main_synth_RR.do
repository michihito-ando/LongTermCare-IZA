...
*synth outcome setup
do "do/synth_y_setup_RR/synth_$outcome.do"
...
**save Y_treated and Y_synth for graph
 putexcel set "post_synth/twoway/post_synth_RR_$outcome.xlsx", replace
...
*save Y_synth for graph
 putexcel set "post_synth/twoway/post_synth_RR_$outcome.xlsx", modify
