...
global outcome "oldage_inkind_pc" // in-kind benefits for elderly, per elderly 190701

global outcome "soexp_health" //  social expenditure for health
global outcome "soexp_health_pc" // social expenditure for health, per capita 190701

global outcome "lfp_30to34_fe" //   labor force participation 30-34, female (recovered)
global outcome "lfp_35to39_fe" //   labor force participation 35-39, female(recovered)
...
global outcome "share_hours_worked_female" // female share of total hours worked (Olivetti 2016 Annul Rev Econ)
global outcome "Femp_rate" // Female employment to population ratio (%) (Olivetti 2017 JEP)
global outcome "E_gap" // Gender employment gap (%) (Olivetti 2017 JEP)
...
global outcome "d_lfp_55to59_v2_fe" //  diff of labor force participation 55-59 - 45-49, female
global outcome "d_lfp_55to59_men" //  diff of labor force participation 55-59 - 45-49, male

*demeaned outcomes
global outcome "demean_oldage_inkind" //  in-kind benefits for elderly
global outcome "demean_soexp_health" //  social expenditure for health
global outcome "demean_lfp_30to34_fe" //   labor force participation 30-34, female
global outcome "demean_lfp_35to39_fe" //   labor force participation 35-39, female
global outcome "demean_lfp_40to44_fe" //   labor force participation 40-44, female
global outcome "demean_lfp_45to49_fe" // 
global outcome "demean_lfp_50to54_fe" // 
global outcome "demean_lfp_55to59_fe" // 
global outcome "demean_d_lfp_50to54_fe" //  diff of labor force participation 50-54 - 45-49, female
global outcome "demean_d_lfp_55to59_fe" //  diff of labor force participation 55-59 - 45-49, female

global outcome "health_social_emp" //  total health and social employment
...
* Note that for demeaned outcomes, only pre-intervention outcomes are used as predictors


foreach name in oldage_inkind /*soexp_health lfp_50to54_fe lfp_55to59_fe d_lfp_50to54_fe d_lfp_55to59_fe demean_oldage_inkind demean_soexp_health demean_lfp_30to34_fe demean_lfp_35to39_fe demean_lfp_40to44_fe demean_lfp_45to49_fe demean_lfp_50to54_fe demean_lfp_55to59_fe demean_d_lfp_50to54_fe demean_d_lfp_55to59_fe*/ {
